...
function initRuntimeSocketService() {
  const hosts = "192.168.96.163,192.168.140.123,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_lpTgac";
...
const pages = [
  ...
  {
    path: "pages/avatar/avatarView",
    style: {
      navigationBarTitleText: "头像贴图预览",
      enablePullDownRefresh: false
    }
  },
  {
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      text: "幸运",
      iconPath: "static/tabbar/r.png",
      selectedIconPath: "/static/tabbar/r_s.png"
    },
    {
      pagePath: "pages/bg/bg",
      text: "聊天背景",
...
const b = true, E = "mp-weixin", P = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = E, A = T('{"address":["127.0.0.1","192.168.96.163","129.0.16.245"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/Program Files/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"avatar","spaceId":"mp-4ad33283-976b-419b-b89c-fe85a5e40663","clientSecret":"XHYza61y0Ty+KW+25klbqA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__31A0380";
} catch (e2) {
